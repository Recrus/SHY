...
use App\Http\Controllers\Api\V1\ExamLinkController;
...
Route::apiResource('exam-links', ExamLinkController::class);
...
Route::get('question/{question}/answers', [QuestionController::class, 'answers']);
...
Route::get('exams-analytics', [ExamController::class, 'userExamsAnalytics']);
